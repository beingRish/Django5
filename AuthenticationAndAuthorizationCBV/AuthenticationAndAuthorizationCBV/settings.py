...
SECRET_KEY = 'django-insecure-r7$)ln1^&0#y7(j#d-r22_8pdo#^zlhydvag!s^c=e-f^w8@fs'
...
ROOT_URLCONF = 'AuthenticationAndAuthorizationCBV.urls'
...
WSGI_APPLICATION = 'AuthenticationAndAuthorizationCBV.wsgi.application'
